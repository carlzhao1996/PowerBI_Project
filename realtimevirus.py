...
def getepoch(date_time_now): # Method to convert current date and time to epoch time 
   # date_time_now = datetime.strftime(datetime.now(),datetimestr)
    print date_time_now
...
def requestmonitor(conn,epoch=None): # Method to get Request information 
...
def virusmonitor(conn,epoch=None): # Method to get virus information
